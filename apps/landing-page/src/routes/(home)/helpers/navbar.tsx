  ...
  return (
    <header className="site-header">
      <nav
        ...
        className="page-shell grid h-[104px] grid-cols-[220px_1fr_auto] items-center max-landing-lg:h-[86px] max-landing-md:h-[76px] max-landing-lg:grid-cols-[1fr_auto] max-landing-xl:grid-cols-[150px_1fr_auto]"
      >
        <Wordmark aria-label="Suwa home" href="#top" />
        <div className="flex items-center justify-center gap-[clamp(24px,3vw,48px)] whitespace-nowrap text-[#172e29] text-[14px] max-landing-lg:hidden">
        ...
        <div className="flex items-center gap-[34px] whitespace-nowrap pl-[42px] text-[13px] max-landing-lg:pl-[24px] max-landing-xl:pl-[24px]">
