    ...
    <View className="gap-14 pb-12">
      <Animated.View className="gap-2 px-1" entering={FadeInDown.duration(600)}>
        ...
        <Text className="mt-1 font-normal font-sans text-muted-foreground text-sm leading-relaxed">
          Monitor wellness, sprite health, and activity progress of your linked
          patients.
        </Text>
      </Animated.View>
            ...
            >
              <View className="flex-row gap-3 px-1">
                {patients.map((patient) => (
                  <Pressable
                    className="w-48 gap-3 rounded-card border-2 border-border bg-card p-4"
                    key={patient.userId}
            ...
            >
              ...
              <View className="gap-3">
                {patients.slice(1).map((patient) => (
                  <Pressable
                    className="flex-row items-center gap-4 rounded-card border-2 border-border bg-card p-4"
                    key={patient.userId}
                    onPress={() => router.push("/activities")}
                  >
