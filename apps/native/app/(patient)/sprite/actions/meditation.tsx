...
import { ArrowLeft, Sparkles, Timer, Zap } from "lucide-react-native";
    ...
    <>
      ...
      <Screen contentClassName="bg-background">
        <View className="flex-1 items-center justify-between px-page py-12">
          ...
          <View className="relative w-full flex-1 items-center justify-center">
            ...
            <Animated.View
              className="h-32 w-32 items-center justify-center rounded-full shadow-accent"
              style={{
            ...
            <View className="absolute bottom-[-80] items-center gap-1">
              <Animated.Text
                className="font-black font-sans text-3xl text-accent uppercase tracking-widest"
                style={{
              ...
              <View className="items-center gap-4 rounded-card border-2 border-success/30 bg-success/10 p-6">
                ...
                <View className="items-center">
                  ...
                  <Text className="text-center font-bold font-sans text-success/80 text-xs">
                    Your Sprite feels centered. You earned +10 Moonlight
                    Credits.
                  </Text>
                </View>
                <Button
      ...
      <ScreenBottomBar>
        {running ? (
            ...
            <View className="mr-2 h-12 flex-[1.2] flex-row items-center justify-center gap-3 rounded-control border-2 border-border bg-background px-3 py-2">
              ...
              <View className="flex-1 gap-1">
                <View className="flex-row items-center justify-between">
                  ...
                  <Text className="font-black font-sans text-[10px] text-accent">
                    {minutes}m
                  </Text>
                </View>
          ...
          <>
            <View className="mr-2 flex-[1.2] flex-row gap-1">
              {[5, 10, 15, 20].map((m) => (
                <Pressable
                ...
                >
                  <Text
                    className={`font-black font-sans text-[10px] ${minutes === m ? "text-accent" : "text-muted-foreground"}`}
                  >
                    {m}m
                  </Text>
                </Pressable>
